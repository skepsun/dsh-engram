/**
 * dsh-loom: user settings binding (host half).
 *
 * Registers the `dsh-loom` settings namespace through DSH's own settings
...
export const SETTINGS_NS_NAME = "dsh-loom";
...
export function makeSettingsSchema(defaults) {
  return z.object({
    ...
    // loopback fence for /api/dsh-loom (operator-authorized tunnel hosts).
 ...
 */
export function installLoomSettings(ctx, defaults, live) {
