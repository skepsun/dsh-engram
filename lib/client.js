...
function StatCard({ num, label }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.card, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.cardNum, children: num }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.cardLabel, children: label })
  ] });
}
...
function EngramSection({ api, t }) {
  const [overview, setOverview] = (0, import_react6.useState)(null);
  ...
  const [usageStats, setUsageStats] = (0, import_react6.useState)(null);
  const [error, setError] = (0, import_react6.useState)(null);
  const [workspace, setWorkspace] = (0, import_react6.useState)("");
  const [kind, setKind] = (0, import_react6.useState)("");
  const [status, setStatus] = (0, import_react6.useState)("active");
  const [q, setQ] = (0, import_react6.useState)("");
  const [busy, setBusy] = (0, import_react6.useState)(false);
  const [memPage, setMemPage] = (0, import_react6.useState)(0);
  const [expandedRows, setExpandedRows] = (0, import_react6.useState)(/* @__PURE__ */ new Set());
  const [view, setView] = (0, import_react6.useState)("mem");
  const [gcDryRun, setGcDryRun] = (0, import_react6.useState)(true);
  const [gcReport, setGcReport] = (0, import_react6.useState)(null);
  const [gcRunning, setGcRunning] = (0, import_react6.useState)(false);
  const [newTaskWs, setNewTaskWs] = (0, import_react6.useState)("");
  const [newTaskName, setNewTaskName] = (0, import_react6.useState)("");
  const [newTaskDesc, setNewTaskDesc] = (0, import_react6.useState)("");
  const [newTaskBusy, setNewTaskBusy] = (0, import_react6.useState)(false);
  const [closeFor, setCloseFor] = (0, import_react6.useState)(null);
  const [closeArtifact, setCloseArtifact] = (0, import_react6.useState)("");
  const [closeEval, setCloseEval] = (0, import_react6.useState)("");
  const [closeRefs, setCloseRefs] = (0, import_react6.useState)("");
  const [closeBusy, setCloseBusy] = (0, import_react6.useState)(false);
  ...
  const workspaces = (0, import_react6.useMemo)(() => overview ? Object.keys(overview.workspaces) : [], [overview]);
  const kindsPresent = (0, import_react6.useMemo)(() => overview ? Object.keys(overview.kinds) : [], [overview]);
  ...
  const { vars } = useEngramTheme();
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { ...s2.root, ...vars }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h1", { style: s2.h1, children: "Engram \u8BB0\u5FC6" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { style: s2.sub, children: "\u8DE8\u4F1A\u8BDD\u8BB0\u5FC6 \xB7 \u96F6 LLM \u81EA\u52A8\u6355\u83B7 \xB7 \u7B26\u53F7\u7D22\u5F15\u6E10\u8FDB\u62AB\u9732 \u2014 \u6570\u636E\u6E90 ~/.dsh/storages/dsh_engram.json" }),
    error && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.error, children: [
      t("error"),
      ": ",
      error
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.tabBar, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: view === "mem" ? s2.tabActive : s2.tab, onClick: () => setView("mem"), children: "\u8BB0\u5FC6" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: view === "esr" ? s2.tabActive : s2.tab, onClick: () => setView("esr"), children: "ESR\uFF08\u4EFB\u52A1 \xB7 \u8282\u70B9 \xB7 \u5173\u7CFB\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: view === "graph" ? s2.tabActive : s2.tab, onClick: () => setView("graph"), children: "\u5173\u7CFB\u56FE\u8C31" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: view === "preview" ? s2.tabActive : s2.tab, onClick: () => setView("preview"), children: "\u6CE8\u5165\u9884\u89C8" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: view === "telemetry" ? s2.tabActive : s2.tab, onClick: () => setView("telemetry"), children: "\u9065\u6D4B" })
    ] }),
    view === "mem" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      overview && (() => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.stats, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(memNum), label: wsCounts ? "\u8BB0\u5FC6 (active)" : "\u8BB0\u5FC6 (active, \u5168\u5C40)" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(taskNum), label: wsCounts ? "\u4EFB\u52A1 (active)" : "\u4EFB\u52A1 (active, \u5168\u5C40)" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(linkNum), label: wsCounts ? "\u5173\u7CFB" : "\u5173\u7CFB (\u5168\u5C40)" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(wsCounts ? wsCounts.nodes ?? 0 : overview.totals.nodes ?? 0), label: wsCounts ? "\u8282\u70B9" : "\u8282\u70B9 (\u5168\u5C40)" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(workspaces.length), label: "\u5DE5\u4F5C\u533A" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(overview.captures.total), label: "\u81EA\u52A8\u6355\u83B7" }),
          ...
          gc && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            StatCard,
            {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.subPanel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontWeight: 700, fontSize: 13 }, children: "\u8BB0\u5FC6 GC\uFF08pi-esr \u7EA6\u675F\uFF09" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { style: { fontSize: 12, display: "inline-flex", gap: 4, alignItems: "center" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { type: "checkbox", checked: gcDryRun, onChange: (e) => setGcDryRun(e.target.checked) }),
            "\u4EC5\u9884\u89C8\uFF08dry run\uFF09"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btnPrimary, onClick: () => void runGc(), disabled: gcRunning || !workspace, children: gcRunning ? "\u2026" : "\u8FD0\u884C GC" }),
          gc && gc.lastRun > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: s2.mono, children: [
            "\u4E0A\u6B21 ",
            fmtDate(gc.lastRun)
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { fontSize: 11.5, color: "var(--dsh-color-muted, #6b7280)", marginTop: 4 }, children: "\u5DE5\u4F5C\u96C6\uFF08active \u4EFB\u52A1\u5F15\u7528 / \u4EFB\u52A1\u8BB0\u5FC6 / \u5DF2\u5165\u7D22\u5F15\u547D\u4E2D\uFF09\u6C38\u4E0D\u9A71\u9010\uFF1BTTL \u8FC7\u671F\u5F52\u6863\u3001\u8D85\u5BB9\u91CF\u6DD8\u6C70\u3001stable \u4EFB\u52A1\u8D85\u7A97\u5F52\u6863\u3001\u60AC\u7A7A\u94FE\u63A5\u6E05\u7406\u3002\u53EA\u5F52\u6863\u4E0D\u786C\u5220\u2014\u2014\u6761\u76EE id \u4FDD\u6301\u53EF\u91CD\u53D6\u3002" }),
        gcReport && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { marginTop: 8, fontSize: 12.5 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
            gcReport.dryRun ? "dry-run \u9884\u89C8\uFF1A" : "\u5DF2\u6267\u884C\uFF1A",
            " ",
            "\u5F52\u6863\u8BB0\u5FC6 ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("b", { children: gcReport.archivedMemories.length }),
            " \xB7 \u5F52\u6863\u4EFB\u52A1 ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("b", { children: gcReport.archivedTasks.length }),
            " \xB7 \u6E05\u7406\u94FE\u63A5 ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("b", { children: gcReport.removedLinks.length }),
            " \xB7 \u4FDD\u62A4 ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("b", { children: gcReport.protectedMemories })
          ] }),
          gcReport.archivedMemories.slice(0, 5).map((e) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.mono, children: [
            "- ",
            e.id.slice(0, 8),
            " ",
            e.reason,
          ...
          gcReport.archivedTasks.slice(0, 3).map((t2) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.mono, children: [
            "- ",
            t2.id.slice(0, 6),
            " ",
            t2.reason,
          ...
          gcReport.removedLinks.slice(0, 3).map((l) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.mono, children: [
            "- link ",
            l.source.slice(0, 8),
            " --",
            l.relation,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.row, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { style: s2.input, value: workspace, onChange: (e) => setWorkspace(e.target.value), children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "", children: "\u5168\u90E8\u5DE5\u4F5C\u533A" }),
          workspaces.map((ws) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("option", { value: ws, children: [
            ws,
            "\uFF08",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btn, disabled: workspace === "" || workspaces.length === 0, onClick: () => goWorkspace(-1), children: "\u2039 \u4E0A\u4E00\u5DE5\u4F5C\u533A" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btn, disabled: workspace === "" || workspaces.length === 0, onClick: () => goWorkspace(1), children: "\u4E0B\u4E00\u5DE5\u4F5C\u533A \u203A" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { style: s2.input, value: kind, onChange: (e) => setKind(e.target.value), children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "", children: "\u5168\u90E8\u7C7B\u578B" }),
          kindsPresent.map((k) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: k, children: KIND_LABEL[k] ?? k }, k))
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { style: s2.input, value: status, onChange: (e) => setStatus(e.target.value), children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "active", children: "\u4EC5\u6D3B\u52A8" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "all", children: "\u5168\u90E8\u72B6\u6001" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "archived", children: "\u5DF2\u5F52\u6863" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "input",
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btnPrimary, onClick: () => void refresh(), disabled: busy, children: busy ? "\u2026" : t("refresh") })
      ] }),
      cfg && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.row, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: s2.tag, children: [
          "autoCapture ",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("table", { style: s2.table, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("colgroup", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("col", { style: { width: 58 } }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("col", {}),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("col", { style: { width: 72 } })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("tr", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { style: s2.th, children: "\u7C7B\u578B" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { style: s2.th, children: "\u5185\u5BB9" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { style: s2.th })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("tbody", { children: [
          flatRows.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { colSpan: 3, style: s2.empty, children: "\u6682\u65E0\u8BB0\u5FC6 \u2014 \u4F7F\u7528 engram_store \u663E\u5F0F\u8BB0\u5F55\uFF0C\u6216\u8BA9\u81EA\u52A8\u6355\u83B7\u5DE5\u4F5C\uFF08git \u63D0\u4EA4 / \u5173\u952E\u6587\u4EF6\u7F16\u8F91 / \u5DE5\u5177\u9519\u8BEF\uFF09" }) }),
          memPageRows.map(
            (r) => r.kind === "head" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("td", { colSpan: 3, style: s2.wsHead, children: [
              r.ws,
              " \xB7 ",
              r.count,
              " \u6761"
            ] }) }, `h-${r.ws}`) : /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("tr", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("td", { style: { ...s2.td, whiteSpace: "nowrap" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { ...s2.badge, background: KIND_COLORS[r.m.kind] ?? "#6b7280" }, children: KIND_LABEL[r.m.kind] ?? r.m.kind }),
                r.m.status === "archived" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { ...s2.tag, color: "#b45309", background: "#fef3c7" }, children: "archived" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("td", { style: { ...s2.td, minWidth: 0 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { title: r.m.text, style: expandedRows.has(r.m.id) ? s2.expanded : s2.clamp3, children: r.m.text }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center", marginTop: 2, flexWrap: "wrap" }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { ...s2.mono, ...s2.ellipsis, flex: "1 1 160px" }, title: `${fmtDate(r.m.createdAt)} \xB7 ${r.m.id} \xB7 ${r.m.entity ?? ""} \xB7 signal ${r.m.signal.toFixed(2)} \xB7 hits ${r.m.hits} \xB7 TTL ${daysLeft(r.m.expiresAt)}`, children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.linkBtn, onClick: () => toggleExpand(r.m.id), children: expandedRows.has(r.m.id) ? "\u6536\u8D77" : "\u5C55\u5F00\u5168\u6587" })
                ] }),
                r.m.tags.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { marginTop: 3, display: "flex", flexWrap: "wrap", gap: 4 }, children: r.m.tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s2.tag, children: tag }, tag)) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { style: s2.td, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 4, alignItems: "flex-start" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btn, title: "\u5F52\u6863\uFF08TTL/\u8F6F\u5220\uFF0C\u53EF\u6062\u590D\u4E0D\u8F7D\u5165\u7D22\u5F15\uFF09", onClick: () => void act(() => api.archive(r.m.id, r.m.workspace)), children: "\u5F52\u6863" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btn, title: "\u6C38\u4E45\u5220\u9664", onClick: () => {
...
${r.m.text.slice(0, 60)}`)) void act(() => api.remove(r.m.id, r.m.workspace));
      ...
      flatRows.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.pageBar, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btn, disabled: memPageSafe === 0, onClick: () => setMemPage(memPageSafe - 1), children: "\u2039 \u4E0A\u4E00\u9875" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btn, disabled: memPageSafe >= memPageCount - 1, onClick: () => setMemPage(memPageSafe + 1), children: "\u4E0B\u4E00\u9875 \u203A" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("select", { style: s2.input, value: memPageSafe, onChange: (e) => setMemPage(Number(e.target.value)), title: "\u8DF3\u9875", children: Array.from({ length: memPageCount }, (_, i) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("option", { value: i, children: [
          "\u7B2C ",
          i + 1,
          " \u9875"
        ] }, i)) })
    ...
    view === "esr" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.stats, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(wsCounts ? wsCounts.tasks : overview?.totals.tasks ?? 0), label: wsCounts ? "\u4EFB\u52A1 (active)" : "\u4EFB\u52A1 (active, \u5168\u5C40)" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(wsCounts ? wsCounts.links : overview?.totals.links ?? 0), label: wsCounts ? "\u5173\u7CFB" : "\u5173\u7CFB (\u5168\u5C40)" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StatCard, { num: String(wsCounts ? wsCounts.nodes ?? 0 : overview?.totals.nodes ?? 0), label: wsCounts ? "\u8282\u70B9" : "\u8282\u70B9 (\u5168\u5C40)" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.subPanel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { fontWeight: 700, fontSize: 13, marginBottom: 6 }, children: [
          "agent \u884C\u4E3A\u89C2\u6D4B",
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontSize: 11.5, fontWeight: 400, color: "var(--dsh-color-muted, #6b7280)" }, children: " \xB7 \u6BCF\u6B21 engram_*/esr_* \u5DE5\u5177\u8C03\u7528\u5B9E\u65F6\u7D2F\u8BA1\uFF08\u771F\u5B9E\u6570\u636E\uFF0C\u6309\u5DE5\u4F5C\u533A/\u5929\u6EDA\u52A8\uFF09" })
        ] }),
        !usageStats ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.mono, children: "\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" }, children: [
            ...
            usageStats.ratios.calls < 10 && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: s2.tag, children: [
              "\u6837\u672C\u4E0D\u8DB3\uFF08",
              usageStats.ratios.calls,
              " \u6B21\uFF09\uFF0C\u6BD4\u4F8B\u4EC5\u4F9B\u53C2\u8003"
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { fontSize: 11.5, color: "var(--dsh-color-muted, #6b7280)", marginTop: 4 }, children: "ESR \u4E3B\u52A8\u6027\u8FC7\u4F4E\u65F6\uFF0C\u4E0B\u4E00\u4E2A\u4F1A\u8BDD\u7684 [ESR] \u6CE8\u5165\u5757\u4F1A\u9644\u52A0\u4E00\u884C\u57FA\u4E8E\u771F\u5B9E\u6570\u636E\u7684 escalate \u63D0\u9192\uFF0C\u5F15\u5BFC\u6A21\u578B\u5F53\u573A\u8865\u5EFA\u4EFB\u52A1/\u8282\u70B9/\u5173\u7CFB\u2014\u2014\u6BD4\u4F8B\u56DE\u5347\u540E\u63D0\u9192\u81EA\u52A8\u6D88\u5931\u3002" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { fontSize: 11.5, color: "var(--dsh-color-muted-weak, #9ca3af)", marginTop: 5, display: "flex", gap: 4, flexWrap: "wrap", alignItems: "center" }, children: [
            "\u5DE5\u5177\u8C03\u7528\uFF1A",
            Object.entries(usageStats.totals.counts).map(([k, v]) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: s2.tag, children: [
              k,
              " \xD7",
              v
            ] }, k))
          ] }),
          usageStats.byDay.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { fontSize: 11.5, color: "var(--dsh-color-muted, #6b7280)", marginTop: 4, display: "flex", gap: 8, flexWrap: "wrap" }, children: usageStats.byDay.map((d) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { children: [
            d.day,
            " \xB7 \u8C03\u7528 ",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.panelTitle, children: [
        "ESR \u4EFB\u52A1\uFF08\u8BC1\u636E\u95ED\u73AF\uFF09",
        workspace === "" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontSize: 12, fontWeight: 400, color: "var(--dsh-color-muted, #9ca3af)" }, children: "\xB7 \u5168\u90E8\u5DE5\u4F5C\u533A" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.subPanel, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { style: s2.input, value: newTaskWs, onChange: (e) => setNewTaskWs(e.target.value), children: [
          workspaces.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "", children: "(no workspaces)" }),
          workspaces.map((ws) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: ws, children: ws }, ws))
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { style: { ...s2.input, width: 170 }, placeholder: "\u4EFB\u52A1\u540D\u2026", value: newTaskName, onChange: (e) => setNewTaskName(e.target.value), onKeyDown: (e) => {
          if (e.key === "Enter") void createNewTask();
        } }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { style: { ...s2.input, width: 240 }, placeholder: "\u8981\u4EA7\u51FA / \u6EE1\u8DB3\u4EC0\u4E48\uFF08\u53EF\u9009\uFF09", value: newTaskDesc, onChange: (e) => setNewTaskDesc(e.target.value) }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btnPrimary, disabled: newTaskBusy || newTaskName.trim() === "", onClick: () => void createNewTask(), children: newTaskBusy ? "\u2026" : "\u65B0\u5EFA\u4EFB\u52A1" })
      ] }) }),
      tasks.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.empty, children: "\u6682\u65E0\u4EFB\u52A1 \u2014 \u7528\u4E0A\u65B9\u300C\u65B0\u5EFA\u4EFB\u52A1\u300D\u6216 esr_task \u5DE5\u5177\u521B\u5EFA" }),
      taskGroups.map(([ws, items]) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_react6.Fragment, { children: [
        workspace === "" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.groupLabel, children: [
          ws,
          " \xB7 ",
          items.length,
          " \u4E2A\u4EFB\u52A1"
        ...
        items.map((task) => {
          ...
          const isStable = task.state === "stable";
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.subPanel, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { fontWeight: 600, fontSize: 13 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s2.mono, children: task.id.slice(0, 6) }),
              " ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                EvidenceRing,
                {
              ...
              task.name,
              " ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { ...s2.badge, background: isStable ? "#059669" : gaps.length === 0 ? "#2563eb" : "#d97706" }, children: isStable ? "STABLE" : gaps.length === 0 ? "READY" : "ACTIVE" }),
              !isStable && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btn, onClick: () => setCloseFor(closeFor === task.id ? null : task.id), children: closeFor === task.id ? "\u6536\u8D77" : "\u586B\u5199\u8BC1\u636E\u5173\u95ED\u2026" })
            ] }),
            !isStable && gaps.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { fontSize: 12, color: "var(--dsh-color-muted, #6b7280)", marginTop: 4 }, children: [
              "\u7F3A\u53E3\uFF1A",
              gaps.join(", "),
              " \u2014 \u63D0\u4F9B artifact / evaluation / memory_ref \u540E\u8F6C\u4E3A STABLE"
            ] }),
            task.description && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { fontSize: 12, color: "var(--dsh-color-muted-strong, #4b5563)", marginTop: 4 }, children: task.description }),
            task.memoryRefs.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { fontSize: 12, marginTop: 4 }, children: [
              "\u8BB0\u5FC6\u5F15\u7528\uFF1A",
              task.memoryRefs.map((r) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s2.tag, children: r.slice(0, 8) }, r))
            ] }),
            closeFor === task.id && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { marginTop: 8, padding: 8, border: "1px solid var(--dsh-color-border, #e5e7eb)", borderRadius: 8 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { fontSize: 11, color: "var(--dsh-color-muted, #6b7280)", marginBottom: 6 }, children: "\u63D0\u4F9B\u8BC1\u636E\u540E\u5173\u95ED\uFF08\u4E09\u9879\u5168\u9F50\u624D\u8F6C STABLE\uFF09" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { style: { ...s2.input, width: 150 }, placeholder: "artifact \u8DEF\u5F84/URL", value: closeArtifact, onChange: (e) => setCloseArtifact(e.target.value) }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { style: { ...s2.input, width: 150 }, placeholder: "evaluation \u9A8C\u8BC1\u8BC1\u636E", value: closeEval, onChange: (e) => setCloseEval(e.target.value) }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { style: { ...s2.input, width: 150 }, placeholder: "memory_refs \u9017\u53F7\u5206\u9694", value: closeRefs, onChange: (e) => setCloseRefs(e.target.value) }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btnPrimary, disabled: closeBusy, onClick: () => void submitClose(task), children: closeBusy ? "\u2026" : "\u63D0\u4EA4\u5173\u95ED" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s2.btn, onClick: () => setCloseFor(null), children: "\u53D6\u6D88" })
              ] })
            ] })
          ] }, task.id);
        })
      ...
      nodes.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.empty, children: "\u6682\u65E0\u8282\u70B9 \u2014 \u6A21\u578B\u4F1A\u4E3A\u53CD\u590D\u51FA\u73B0\u7684\u9886\u57DF\u5BF9\u8C61\u4E3B\u52A8\u767B\u8BB0\uFF08esr_node\uFF09\uFF0C\u6B64\u5904\u4E5F\u53EF\u67E5\u770B\u5173\u7CFB" }),
      nodeGroups.map(([ws, items]) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_react6.Fragment, { children: [
        workspace === "" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.groupLabel, children: [
          ws,
          " \xB7 ",
          items.length,
        ...
        items.map((n) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { fontSize: 12.5, padding: "2px 0" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "mono", style: { ...s2.mono, color: "#4338ca" }, children: n.id.slice(0, 24) }),
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontWeight: 600 }, children: n.name }),
          n.kind && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { ...s2.tag, color: "#4338ca", background: "#eef2ff" }, children: n.kind }),
          n.description && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: { color: "var(--dsh-color-muted, #6b7280)" }, children: [
            " \u2014 ",
            n.description.slice(0, 48)
          ] })
        ] }, n.id))
      ] }, ws)),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { fontSize: 12, color: "var(--dsh-color-muted, #6b7280)", marginTop: 6 }, children: "\u5173\u7CFB\uFF1A" }),
      links.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.empty, children: "\u6682\u65E0\u5173\u7CFB \u2014 esr_link \u521B\u5EFA" }),
      linkGroups.map(([ws, items]) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_react6.Fragment, { children: [
        workspace === "" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.groupLabel, children: [
          ws,
          " \xB7 ",
          items.length,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6, marginTop: 4 }, children: items.map((l) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.relRow, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "mono", style: s2.nodePill, title: l.source, children: nameOf(l.source) }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 3, fontSize: 11, color: "var(--dsh-color-muted, #6b7280)" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { border: "1px dashed var(--dsh-color-border, #cbd5e1)", borderRadius: 999, padding: "1px 7px" }, children: l.relation }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { "aria-hidden": true, children: "\u2192" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "mono", style: s2.nodePill, title: l.target, children: nameOf(l.target) }),
    ...
    view === "graph" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s2.subPanel, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { fontWeight: 700, fontSize: 13 }, children: "\u5173\u7CFB\u56FE\u8C31\uFF08esr_link \u529B\u5BFC\u5411\u56FE\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: { fontSize: 11.5, fontWeight: 400, color: "var(--dsh-color-muted, #6b7280)" }, children: [
    ...
    view === "preview" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.subPanel, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(EngramPreview, { api, workspace, workspaces }) }),
    view === "telemetry" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s2.subPanel, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(EngramTelemetry, { api, workspace }) })
  ] });
}
...
function EngramConfigCard({ scope }) {
  const [snap, setSnap] = (0, import_react7.useState)(null);
  ...
  const setField = (0, import_react7.useCallback)((key, value2) => {
  ...
  const resetField = (0, import_react7.useCallback)(async (key) => {
    setError(null);
    try {
  ...
  const { vars } = useEngramTheme();
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: vars, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: available ? { ...s3.card, ...open ? s3.cardOpen : void 0 } : { display: "none" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { style: s3.headText, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: s3.name, children: "dsh-engram" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: s3.description, children: CARD_DESCRIPTION })
          ] }),
          anyDirty && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: s3.pending, children: "\u672A\u4FDD\u5B58" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Chevron, { open })
        ]
      }
    ),
    open && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: s3.body, children: [
      !writable && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { style: s3.readOnly, children: "\u672C\u90E8\u7F72\u7684\u8BBE\u7F6E\u4E3A\u53EA\u8BFB\uFF08\u5BBF\u4E3B\u672A\u6388\u6743\u5199\u5165\u6216\u9700\u91CD\u542F\u5E94\u7528\uFF09\u3002" }),
      GROUPS.map((group) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: s3.groupPanel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: s3.groupHead, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: s3.groupTitle, children: group.title }),
          group.description && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: s3.groupDesc, children: group.description })
        ] }),
        group.fields.map((field) => {
          const raw = value[field.key];
          const overridden = snap?.user !== void 0 && field.key in snap.user;
          return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: s3.row, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: s3.label, children: field.label }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: s3.hint, children: field.hint })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
              field.kind === "bool" ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                "input",
                {
                  type: "checkbox",
                  checked: raw === true,
              ...
              ) : field.kind === "text" ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                "input",
                {
                  type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: s3.note, children: "\u8BBE\u7F6E\u5BF9\u65B0\u5EFA\u4F1A\u8BDD\u5373\u65F6\u751F\u6548\uFF1B\u5DF2\u51BB\u7ED3\u7684 [ENGRAM] \u5757\u4FDD\u6301\u524D\u7F00\u7A33\u5B9A\u3002" }),
      error && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: s3.failed, children: error }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: s3.footer, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          "button",
          {
            type: "button",
...
var fmtDate2 = (ts) => ts ? new Date(ts).toLocaleDateString("zh-CN", { month: "short", day: "numeric" }) : "\u2013";
function shortId(id) {
  return id.length > 12 ? `${id.slice(0, 6)}\u2026${id.slice(-4)}` : id;
}
function EngramBoard({ api, onRequestClose }) {
  const { vars } = useEngramTheme();
  const [overview, setOverview] = (0, import_react8.useState)(null);
  const [tasksByWs, setTasksByWs] = (0, import_react8.useState)({});
  const [loading, setLoading] = (0, import_react8.useState)(true);
  const [denied, setDenied] = (0, import_react8.useState)(false);
  const [error, setError] = (0, import_react8.useState)(null);
  const [ws, setWs] = (0, import_react8.useState)("");
  ...
  const [newDesc, setNewDesc] = (0, import_react8.useState)("");
  const [newWs, setNewWs] = (0, import_react8.useState)("");
  const [busy, setBusy] = (0, import_react8.useState)(false);
  const [closingFor, setClosingFor] = (0, import_react8.useState)(null);
  const [closeArtifact, setCloseArtifact] = (0, import_react8.useState)("");
  const [closeEval, setCloseEval] = (0, import_react8.useState)("");
  const [closeRefs, setCloseRefs] = (0, import_react8.useState)("");
  const loadedWs = (0, import_react8.useRef)(/* @__PURE__ */ new Set());
  ...
  const workspaces = (0, import_react8.useMemo)(
    () => overview ? Object.entries(overview.workspaces).sort((a, b) => b[1].tasks - a[1].tasks) : [],
    [overview]
  );
  const totalActive = (0, import_react8.useMemo)(
    () => workspaces.reduce((a, [, w]) => a + (w.tasks ?? 0), 0),
    [workspaces]
  );
  const allTasks = (0, import_react8.useMemo)(() => Object.values(tasksByWs).flat(), [tasksByWs]);
  const evidenceGauge = (0, import_react8.useMemo)(() => {
    let active = 0;
    let gateTotal = 0;
    let gateFilled = 0;
    let ready = 0;
  ...
  const columnCounts = (0, import_react8.useMemo)(() => {
    const counts = {};
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { "data-engram-board": "true", style: { ...vars, height: "100%", display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--dsw-alias-bg-layer-1, var(--dsh-color-surface, #fff))" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: hb.header, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", style: { color: "var(--dsw-alias-label-primary-bluish, #4338ca)" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("rect", { x: "2", y: "2.5", width: "12", height: "11", rx: "2.5", stroke: "currentColor", strokeWidth: "1.3" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: "M5.2 8.1l1.8 1.8 3.8-4", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: hb.title, children: "ESR \u4EFB\u52A1\u770B\u677F" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: hb.sub, children: "draft \u2192 active(\u8BC1\u636E) \u2192 stable \xB7 \u8DE8\u5DE5\u4F5C\u533A \xB7 \u4E0E esr_task/esr_close \u540C\u4E00\u8BC1\u636E\u95E8" }),
      loading && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: hb.loading, children: "\u2026" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { flex: "1 1 auto" } }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 6 }, title: `\u8BC1\u636E\u5B8C\u5907\u5EA6 ${Math.round(evidenceGauge.frac * 100)}% \xB7 ${evidenceGauge.ready}/${evidenceGauge.active} \u4E2A\u8FDB\u884C\u4E2D\u4EFB\u52A1\u8BC1\u636E\u9F50 \xB7 ${evidenceGauge.stable} \u5DF2\u95ED\u73AF`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(EvidenceRing, { artifact: false, evaluation: false, refs: false, size: 30, showLabel: false, fraction: evidenceGauge.frac }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontSize: 11.5, color: "var(--dsw-alias-label-secondary, var(--dsh-color-muted, #6b7280))", fontWeight: 600 }, children: evidenceGauge.active === 0 ? "\u65E0\u8FDB\u884C\u4E2D" : `${evidenceGauge.ready} \u5C31\u7EEA \xB7 \u5B8C\u5907 ${Math.round(evidenceGauge.frac * 100)}%` })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("select", { style: hb.select, value: ws, onChange: (e) => setWs(e.target.value), title: "\u5DE5\u4F5C\u533A\u7B5B\u9009", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("option", { value: "", children: [
          "\u5168\u90E8\u5DE5\u4F5C\u533A \xB7 ",
          totalActive,
          " \u8FDB\u884C\u4E2D"
        ] }),
        workspaces.map(([w, c]) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("option", { value: w, children: [
          w.replace(/^.*[\\/]/, ""),
          " \xB7 ",
          c.tasks,
          " \u8FDB\u884C\u4E2D"
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", style: hb.btn, onClick: () => {
        setCreating((v) => !v);
        setClosingFor(null);
      }, children: "\uFF0B \u65B0\u5EFA" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", style: hb.btn, onClick: () => void refresh(), disabled: loading, title: "\u5237\u65B0", children: "\u5237\u65B0" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", style: hb.close, onClick: onRequestClose, "aria-label": "\u5173\u95ED\u770B\u677F", children: "\u2715" })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { padding: "0 14px" }, children: [
      denied && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: hb.warn, children: "ESR \u770B\u677F\u6570\u636E\u4E0D\u53EF\u8FBE\uFF08loopback-only \u5B88\u536B\uFF09\u2014 \u4EFB\u52A1/\u5173\u7CFB\u5C06\u65E0\u6CD5\u52A0\u8F7D\uFF1B\u8BF7\u901A\u8FC7\u672C\u673A\u8BBF\u95EE GUI\uFF0C\u6216\u653E\u5165\u53D7\u4FE1\u7F51\u7EDC\u8BBF\u95EE\u3002" }),
      error && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: hb.error, children: [
        "\u26A0 ",
        error
      ] }),
      creating && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: hb.createForm, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("select", { style: hb.select, value: newWs, onChange: (e) => setNewWs(e.target.value), children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "", children: "\u9009\u62E9\u5DE5\u4F5C\u533A\u2026" }),
          workspaces.map(([w]) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: w, children: w.replace(/^.*[\\/]/, "") }, w))
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { style: { ...hb.input, flex: "1 1 200px" }, placeholder: "\u4EFB\u52A1\u540D\u2026", value: newName, onChange: (e) => setNewName(e.target.value), onKeyDown: (e) => {
          if (e.key === "Enter") void submitCreate();
        }, autoFocus: true }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { style: { ...hb.input, flex: "1 1 240px" }, placeholder: "\u8981\u4EA7\u51FA / \u6EE1\u8DB3\u4EC0\u4E48\uFF08\u53EF\u9009\uFF09", value: newDesc, onChange: (e) => setNewDesc(e.target.value) }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", style: hb.btnSolid, disabled: busy || !newName.trim() || !(newWs || workspaces.length > 0), onClick: () => void submitCreate(), children: busy ? "\u2026" : "\u521B\u5EFA" }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", style: hb.btn, onClick: () => setCreating(false), children: "\u53D6\u6D88" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: hb.columns, children: COLUMNS.map((col) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { "data-col": col.key, style: { ...hb.column, borderTop: `2px solid ${col.color}` }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: hb.colHead, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontWeight: 700, fontSize: 12.5 }, children: col.title }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { ...hb.count, color: col.color, background: `${col.color}1f` }, children: columnCounts[col.key] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: hb.colSub, children: col.sub }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6, paddingTop: 6 }, children: [
        filtered.filter(col.match).slice(0, 20).map((t) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: hb.card, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", alignItems: "flex-start", gap: 6 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { ...hb.state, background: col.color }, children: col.key === "stable" ? "\u2713" : "\u25CF" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { fontWeight: 600, fontSize: 12.5, lineHeight: "17px", overflowWrap: "anywhere" }, children: t.name }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", gap: 5, flexWrap: "wrap", marginTop: 3, alignItems: "center" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                  EvidenceRing,
                  {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: hb.meta, children: shortId(t.id) }),
                ws === "" && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: hb.meta, children: t.workspace.replace(/^.*[\\/]/, "") }),
                (col.key === "gapped" || col.key === "ready") && taskGaps3(t).map((g) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { style: hb.gap, children: [
                  g,
                  " \u2717"
                ] }, g)),
                col.key === "stable" && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { style: { fontSize: 10, color: "var(--dsw-alias-label-tertiary, var(--dsh-color-muted-weak, #9ca3af))" }, children: [
                  "artifact",
                  t.artifact ? "\u2713" : "\u2717",
                  "\xB7eval",
                  t.evaluation ? "\u2713" : "\u2717",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: hb.meta, children: fmtDate2(t.createdAt) })
              ] })
            ] })
          ] }),
          col.key === "draft" && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: hb.cardHint, children: "\u8349\u7A3F \xB7 \u7528 esr_task \u53EF\u5C06\u5176\u63A8\u8FDB\u4E3A active" }),
          (col.key === "gapped" || col.key === "ready") && closingFor === t.id ? /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { ...hb.closeForm, borderColor: col.color }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { style: hb.input, placeholder: "\u4EA7\u7269 artifact\uFF08\u6587\u4EF6/PR/\u8DEF\uFF09", value: closeArtifact, onChange: (e) => setCloseArtifact(e.target.value) }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { style: hb.input, placeholder: "\u8BC4\u4F30 evaluation\uFF08\u6D4B\u8BD5/\u8BC4\u5BA1/\u5206\u6570\uFF09", value: closeEval, onChange: (e) => setCloseEval(e.target.value) }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("input", { style: hb.input, placeholder: "\u8BB0\u5FC6\u5F15\u7528 memory_refs\uFF08#id, \u9017\u53F7\u5206\u9694\uFF09", value: closeRefs, onChange: (e) => setCloseRefs(e.target.value) }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", gap: 6 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", style: hb.btnSolid, disabled: busy, onClick: () => void submitClose(t), children: busy ? "\u2026" : "\u6309\u8BC1\u636E\u95ED\u73AF" }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", style: hb.btn, onClick: () => setClosingFor(null), children: "\u53D6\u6D88" })
            ] })
          ] }) : (col.key === "gapped" || col.key === "ready") && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "button", style: hb.advance, onClick: () => {
            setClosingFor(t.id);
          }, children: "\u8865\u9F50\u8BC1\u636E \u2192 \u5173\u95ED" })
        ] }, t.id)),
        filtered.filter(col.match).length > 20 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: hb.more, children: [
          "+",
          filtered.filter(col.match).length - 20,
          " \u66F4\u591A\u2026"
        ] }),
        filtered.filter(col.match).length === 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: hb.empty, children: col.key === "stable" ? "\u8FD8\u6CA1\u6709\u95ED\u73AF\u4EFB\u52A1" : "\u6682\u65E0\u4EFB\u52A1" })
      ] })
    ] }, col.key)) }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: hb.footer, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { children: [
      columnCounts.all,
...
function mountEngramBoard(api) {
  ...
  const ensureContainer = () => {
    ...
    root.render(/* @__PURE__ */ (0, import_jsx_runtime9.jsx)(EngramBoard, { api, onRequestClose: close }));
  };
