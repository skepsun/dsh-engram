...
var EngramApi = class {
  ...
  async updateSettings(ops, expectedRevision) {
    ...
    if (!response.ok) {
      const err = body;
      const message = typeof err?.error === "string" ? err.error : typeof err?.error === "object" && err.error !== null && typeof err.error.message === "string" ? err.error.message : `HTTP ${response.status}`;
      throw new EngramApiError(message);
    }
    return body ?? { ok: true };
  }
...
function buildTasksMarkdown(tasks) {
  const esc = (s4) => String(s4 ?? "").replace(/\|/g, "\\|").replace(/\n/g, " ");
...
var ESR_TOOLS = ["esr_task", "esr_node", "esr_link", "esr_close", "esr_gc"];
var MEM_TOOLS = ["engram_store", "engram_recall", "engram_detail", "loom_store", "loom_recall", "loom_detail"];
function esrToolSum(s4) {
  return ESR_TOOLS.reduce((acc, k) => acc + (s4.tools[k] ?? 0), 0);
}
function memToolSum(s4) {
  return MEM_TOOLS.reduce((acc, k) => acc + (s4.tools[k] ?? 0), 0);
}
...
function EngramTaskDock({ sessionId, useSessions, useWorkspaces, useProjection, api }) {
  ...
  const [taskPage, setTaskPage] = (0, import_react2.useState)(0);
  const [promoted, setPromoted] = (0, import_react2.useState)(/* @__PURE__ */ new Set());
  const [promoteNote, setPromoteNote] = (0, import_react2.useState)(null);
  const [promoteBusy, setPromoteBusy] = (0, import_react2.useState)(false);
  const [toolStats, setToolStats] = (0, import_react2.useState)(null);
  ...
  const [focusWs, setFocusWs] = (0, import_react2.useState)("");
  const [wsOpen, setWsOpen] = (0, import_react2.useState)(false);
  const wsMenuRef = (0, import_react2.useRef)(null);
  ...
  const wsOptions = (0, import_react2.useMemo)(() => {
  ...
  (0, import_react2.useEffect)(() => {
    if (!wsOpen) return;
    const onDoc = (e) => {
      if (wsMenuRef.current && !wsMenuRef.current.contains(e.target)) setWsOpen(false);
    };
  ...
  (0, import_react2.useEffect)(() => {
    let live = true;
    api.toolStats(14).then((r) => {
      if (live) setToolStats(r);
    }).catch(() => {
    });
    return () => {
      live = false;
  ...
  const esrVisible = touched && !data.loading && !data.denied && activeTasks.length > 0;
  ...
  const promoteAll = async () => {
    ...
    if (done.length > 0) {
      setPromoted((prev) => /* @__PURE__ */ new Set([...prev, ...done]));
      void load();
    }
    if (failed.length > 0) {
      setPromoteNote(
        failed.length === done.length ? `\u6C89\u6DC0\u5931\u8D25\uFF1A${failed.length} \u9879\u672A\u80FD\u521B\u5EFA\uFF08\u5DE5\u4F5C\u533A\u5DF2\u6EE1\u6216\u670D\u52A1\u4E0D\u53EF\u8FBE\uFF09\uFF0C\u8BF7\u5237\u65B0\u540E\u91CD\u8BD5` : `\u90E8\u5206\u5931\u8D25\uFF1A${failed.length}/${toPromote.length} \u9879\u672A\u80FD\u521B\u5EFA`
      );
    }
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { ref: wsMenuRef, onClick: (e) => e.stopPropagation(), style: { position: "relative", display: "inline-flex", flex: "none", alignItems: "center" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "span",
                  {
                    role: "button",
                    tabIndex: 0,
                    title: following ? `\u8DDF\u968F\u5F53\u524D\u4F1A\u8BDD \xB7 \u5DE5\u4F5C\u533A ${wsBasename || "\u2014"}\uFF08\u70B9\u51FB\u5207\u6362 ESR \u4EFB\u52A1\u6765\u6E90\uFF09` : `\u5DF2\u56FA\u5B9A\u5230 ${effLabel}\uFF08\u70B9\u51FB\u5207\u6362\uFF09`,
                    onClick: (e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      setWsOpen((v) => !v);
                    ...
                    children: [
                      effLabel,
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 8, opacity: 0.75, marginLeft: 3 }, children: wsOpen ? "\u25B2" : "\u25BC" })
                    ]
                  }
                ),
                !following && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "span",
                  {
                    role: "button",
                    tabIndex: 0,
                ...
                wsOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: wsMenu, role: "menu", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { role: "menuitem", style: wsItem(following), onClick: () => {
                    setFocusWs("");
                    setWsOpen(false);
                  }, children: [
                    "\u8DDF\u968F\u4F1A\u8BDD \xB7 ",
                  ...
                  wsOptions.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { ...wsItem(false), cursor: "default", color: "var(--dsh-color-muted-weak, #9ca3af)" }, children: "\u6682\u65E0\u5176\u4ED6\u5DE5\u4F5C\u533A" }),
                  wsOptions.map((o) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { role: "menuitem", style: wsItem(effWs === o.path && !following), onClick: () => {
                    setFocusWs(o.path);
                    setWsOpen(false);
                  }, children: [
                    o.label,
                    effWs === o.path && !following ? " \u2713" : ""
                  ] }, o.path)),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginTop: 4, paddingTop: 4, borderTop: "1px solid var(--dsh-color-border, #e5e7eb)", fontSize: 10.5, color: "var(--dsh-color-muted-weak, #9ca3af)", padding: "3px 9px" }, children: "\u4EC5\u5207\u6362 ESR \u4EFB\u52A1/\u5173\u7CFB\u6765\u6E90\uFF1B\u5185\u7F6E todo \u4ECD\u5C5E\u672C\u4F1A\u8BDD" })
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "span",
        ...
        !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ed-anim", style: { padding: "2px 12px 12px 15px", display: "flex", flexDirection: "column", gap: 8 }, children: [
          ...
          toolStats && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: statsRow, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
              "\u8FD1 ",
              toolStats.days,
              " \u5929 \xB7 todo ",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: toolStats.tools.todo_write ?? 0 }),
              " \xB7 ",
              "ESR ",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: esrToolSum(toolStats) }),
              " \xB7 ",
              "\u8BB0\u5FC6 ",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: memToolSum(toolStats) }),
              " \xB7 ",
              "\u8C03\u7528 ",
              toolStats.events
            ] }),
            esrToolSum(toolStats) === 0 && toolStats.tools.todo_write > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10.5, color: "var(--dsw-alias-label-dimmed, var(--dsh-color-muted-weak, #9ca3af))" }, children: "\u2014 ESR \u4E3A\u96F6\uFF0Ctodo \u53EF\u7528\u300C\u6C89\u6DC0\u5230 ESR\u300D\u8F6C\u8349\u7A3F" })
          ] }),
          planItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: planBox, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, minWidth: 0 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 12, fontWeight: 600, color: "var(--dsw-alias-label-secondary, var(--dsh-color-muted-strong, #4b5563))" }, children: "\u672C\u8F6E\u8BA1\u5212" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: badgeTodo, children: "\u539F\u751F todo \xB7 \u4F1A\u8BDD\u5185" })
              ] }),
            ...
            (toPromote.length > 0 || promoted.size > 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 6, alignItems: "center", marginTop: 1 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "ed-btn", style: { ...btn, ...btnSolid, padding: "3px 9px", fontSize: 11.5 }, disabled: promoteBusy || toPromote.length === 0, onClick: () => void promoteAll(), title: "\u628A\u672C\u8F6E\u5F85\u529E\u8F6C\u6210 ESR \u4EFB\u52A1\u8349\u7A3F\uFF08\u8DE8\u4F1A\u8BDD\u4FDD\u7559\uFF09", children: promoteBusy ? "\u2026" : promoted.size > 0 ? toPromote.length > 0 ? `\u5DF2\u6C89\u6DC0 ${promoted.size} \u9879 \xB7 \u518D\u6C89\u6DC0 ${toPromote.length} \u9879` : `\u5DF2\u6C89\u6DC0 ${promoted.size} \u9879` : `\u6C89\u6DC0\u5230 ESR\uFF08${toPromote.length} \u9879\uFF09` }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10.5, color: "var(--dsw-alias-label-dimmed, var(--dsh-color-muted-weak, #9ca3af))" }, children: "\u8F6C\u8349\u7A3F \xB7 \u8DE8\u4F1A\u8BDD\u95ED\u73AF" })
            ] }),
            promoteNote && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 11, color: "#dc2626", lineHeight: 1.4 }, role: "alert", children: [
              "\u26A0 ",
              promoteNote
            ] }),
            activeTasks.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 6, alignItems: "flex-start", fontSize: 11.5, lineHeight: 1.5, color: "var(--dsw-alias-label-dimmed, var(--dsh-color-muted, #6b7280))", paddingTop: 2 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { "aria-hidden": true, style: { color: badgeEsr.color }, children: "\u21B3" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
                "\u672C\u8F6E\u8BA1\u5212\u662F",
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "\u4F1A\u8BDD\u5185" }),
                "\u539F\u751F todo\uFF0C\u968F\u4F1A\u8BDD\u7ED3\u675F\uFF1B\u591A\u6B65/\u9700\u957F\u671F\u4FDD\u7559\u7684\u5DE5\u4F5C\u5EFA\u8BAE",
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "\u7528 esr_task \u5EFA ESR \u4EFB\u52A1" }),
                "\uFF08\u8DE8\u4F1A\u8BDD\u95ED\u73AF\uFF0C\u5E26\u8BC1\u636E\u95E8\uFF09\u6C89\u6DC0\u4E0B\u6765\u3002"
              ] })
            ] })
          ] }),
          !data.denied && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 6, minWidth: 0 }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: badgeEsr, children: "ESR \xB7 \u8DE8\u4F1A\u8BDD\u95ED\u73AF" }),
                planItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 10.5, color: "var(--dsw-alias-label-dimmed, var(--dsh-color-muted-weak, #9ca3af))" }, children: [
                  "\u8BA1\u5212 ",
                  planItems.length,
                  " \u6761 todo"
                ] })
            ...
            data.tasks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: taskGrid, children: pagedTasks.map((task) => {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: "1 1 auto", minWidth: 0, display: "flex", flexDirection: "column", gap: 4 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: "var(--dsw-alias-label-tertiary, var(--dsh-color-muted-weak, #9ca3af))", flex: "none" }, children: expanded ? "\u25BE" : "\u25B8" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: isStable ? "var(--dsw-alias-label-tertiary, var(--dsh-color-muted, #6b7280))" : "inherit", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: task.name }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "span",
                          {
                            style: { flex: "none", width: 7, height: 7, borderRadius: "50%", background: statusColor.fg },
                            title: gaps.length > 0 ? `${label} \xB7 \u8BC1\u636E\u7F3A\u53E3: ${gaps.join(", ")}` : label
                          }
                        )
                      ]
                    }
                  ...
                  expanded && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                    task.description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, lineHeight: 1.5, color: "var(--dsw-alias-label-secondary, var(--dsh-color-muted-strong, #4b5563))", overflowWrap: "anywhere" }, children: task.description }),
                    ...
                    !isStable && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "button",
                      {
                        type: "button",
                        className: "ed-btn",
            ...
            data.tasks.length > TASK_PAGE_SIZE && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, justifyContent: "flex-end", fontSize: 11.5, color: "var(--dsw-alias-label-tertiary, var(--dsh-color-muted-weak, #9ca3af))" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
                "\u5171 ",
                data.tasks.length,
                " \xB7 ",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "ed-btn", style: { ...btn, padding: "2px 8px", fontSize: 11.5 }, disabled: taskPage === 0, onClick: () => setTaskPage((v) => Math.max(0, v - 1)), children: "\u2039 \u4E0A\u4E00\u9875" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "ed-btn", style: { ...btn, padding: "2px 8px", fontSize: 11.5 }, disabled: taskPage >= totalPages - 1, onClick: () => setTaskPage((v) => Math.min(totalPages - 1, v + 1)), children: "\u4E0B\u4E00\u9875 \u203A" })
            ] })
          ] })
        ] })
      ]
...
function EngramPreview({ api, workspace, defaultWorkspace, workspaces }) {
  const { dark, vars } = useEngramTheme();
  const [ws, setWs] = (0, import_react4.useState)(workspace || defaultWorkspace || workspaces[0] || "");
...
var MEM_TOOLS2 = ["engram_store", "engram_recall", "engram_detail", "loom_store", "loom_recall", "loom_detail"];
var ESR_TOOLS2 = ["esr_task", "esr_node", "esr_close", "esr_link", "esr_gc"];
...
function EngramTelemetry({ api, workspace }) {
  ...
  const toolRows = (0, import_react5.useMemo)(() => {
    ...
    return entries.slice(0, 8).map(([name, count]) => ({
      name,
      count,
      esc: ESR_TOOLS2.includes(name) ? "esr" : MEM_TOOLS2.includes(name) ? "mem" : "other"
    }));
  }, [stats]);
    ...
    stats && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: hb2.panel, children: [
        ...
        daily.rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: hb2.sub, children: "\u8FD8\u6CA1\u6709\u6309\u5929\u6570\u636E\uFF08\u5DE5\u5177\u8C03\u7528\u4F1A\u5B9E\u65F6\u7D2F\u8BA1\uFF09\u3002" }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("svg", { width: BW, height: BH, viewBox: `0 0 ${BW} ${BH}`, style: { display: "block", maxWidth: "100%" }, children: daily.rows.map((d, i) => {
          const mem = MEM_TOOLS2.reduce((a, k) => a + (d.counts?.[k] ?? 0), 0);
          const esr = ESR_TOOLS2.reduce((a, k) => a + (d.counts?.[k] ?? 0), 0);
          const total = mem + esr;
...
function EngramDetail({ target, api, tasks, nodes, links, onClose, onNavigateMemory, onChanged }) {
  const { dark, vars } = useEngramTheme();
...
function EngramSection({ api, t }) {
  ...
  const [esrGraph, setEsrGraph] = (0, import_react7.useState)(false);
  ...
  const refresh = (0, import_react7.useCallback)(async () => {
    ...
    try {
      ...
      const [mem, taskGroups2, linkGroups2, nodeGroups2] = await Promise.all([
        api.memories({
  ...
  const previewDefault = (0, import_react7.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { ...s2.root, ...vars }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { ...s2.row, marginTop: 2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontWeight: 700, fontSize: 13 }, children: "\u5DE5\u4F5C\u533A\uFF1A" }),
                ...
                (r) => r.kind === "head" ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("td", { colSpan: 3, style: s2.wsHead, children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("td", { style: { ...s2.td, minWidth: 0 }, children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center", marginTop: 2, flexWrap: "wrap" }, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { ...s2.mono, flex: "1 1 160px" }, title: `${fmtDate2(r.m.createdAt)} \xB7 ${r.m.id} \xB7 ${r.m.entity ?? ""} \xB7 signal ${r.m.signal.toFixed(2)} \xB7 hits ${r.m.hits} \xB7 TTL ${daysLeft2(r.m.expiresAt)}`, children: [
...
${r.m.text.slice(0, 60)}`)) void act(() => api.remove(r.m.id, r.m.workspace));
        ...
        view === "esr" && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 6 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontSize: 11.5, color: "var(--dsh-color-muted, #6b7280)" }, children: "\u5DE5\u5177\u8C03\u7528\u4E0E\u547D\u4E2D\u7EDF\u8BA1\u89C1\u300C\u9065\u6D4B\u300Dtab\uFF1B[ESR] \u6CE8\u5165\u5757\u7684 escalate \u63D0\u9192\u4F9D\u636E\u771F\u5B9E\u6570\u636E\u52A8\u6001\u51FA\u73B0\u3002" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { style: { marginLeft: "auto", display: "inline-flex", gap: 6 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", style: esrGraph ? s2.tab : s2.tabActive, onClick: () => setEsrGraph(false), children: "\u5217\u8868" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { type: "button", style: esrGraph ? s2.tabActive : s2.tab, onClick: () => setEsrGraph(true), children: "\u56FE\u8C31" })
            ] })
          ] }),
          esrGraph ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: s2.subPanel, children: [
        ...
        view === "preview" && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: s2.subPanel, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          EngramPreview,
          {
            api,
            workspace,
...
var ADVANCED_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      { key: "maxMemoriesPerWorkspace", label: "\u5DE5\u4F5C\u533A\u8BB0\u5FC6\u4E0A\u9650", hint: "\u5355\u5DE5\u4F5C\u533A\u5BB9\u91CF\u4E0A\u9650\uFF08GC \u5F52\u6863\u8D85\u9650\u6761\u76EE\uFF09", kind: "num", min: 0, max: 1e4 },
...
var FIELDS = [...COMMON_FIELDS, ...ADVANCED_GROUPS.flatMap((group) => group.fields)];
...
function EngramConfigCard({ scope }) {
  ...
  const [advancedOpen, setAdvancedOpen] = (0, import_react8.useState)(false);
  ...
  const renderField = (field) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: s3.row, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        ...
        ) : field.kind === "select" ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "select",
          {
            style: { ...s3.input, width: field.width ?? 160 },
            value: raw === void 0 ? "" : String(raw),
            disabled: !writable,
            onChange: (e) => setField(field.key, e.target.value),
            children: (field.options ?? []).map((opt) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: opt, children: opt }, opt))
          }
  ...
  const renderGroup = (group) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: s3.groupPanel, children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: vars, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { ...s3.card, ...open ? s3.cardOpen : void 0 }, children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: s3.body, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: s3.groupPanel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: s3.groupHead, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: s3.groupTitle, children: "\u5E38\u7528" }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: s3.groupDesc, children: "\u6BCF\u5929\u4F1A\u78B0\u5230\u7684\u65CB\u94AE \xB7 \u5176\u4F59\u6536\u5728\u4E0B\u65B9\u9AD8\u7EA7\u8BBE\u7F6E" })
        ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
        ...
        {
          type: "button",
          style: { ...s3.advHead, ...advancedOpen ? { borderColor: "var(--dsw-alias-label-dimmed, #9ca3af)" } : void 0 },
          "aria-expanded": advancedOpen,
          onClick: () => setAdvancedOpen((v) => !v),
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { style: s3.advHeadLabel, children: [
              "\u9AD8\u7EA7\u8BBE\u7F6E\uFF08",
              ADVANCED_GROUPS.reduce((n, g) => n + g.fields.length, 0),
              " \u9879\uFF09"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Chevron, { open: advancedOpen })
          ]
        }
      ),
...
var EngramScopeImpl = class {
  ...
  async mutate(op) {
    ...
    await this.api.updateSettings([op], revision > 0 ? revision : void 0);
  }
  async set(key, value) {
...
var COLUMNS = [
  ...
  { key: "gapped", title: "\u8FDB\u884C\u4E2D", sub: "\u8BC1\u636E\u6709\u7F3A\u53E3", color: "#f59e0b", match: (t) => t.state === "active" && taskGaps(t).length > 0 },
  { key: "ready", title: "\u5C31\u7EEA", sub: "\u8BC1\u636E\u9F50\uFF0C\u53EF\u95ED\u73AF", color: "#10b981", match: (t) => t.state === "active" && taskGaps(t).length === 0 },
  { key: "stable", title: "\u5DF2\u95ED\u73AF", sub: "\u51ED\u636E\u9F50\u5907", color: "#6366f1", match: (t) => t.state === "stable" }
];
function buildCloseEvidence(bulkArtifact, bulkEval, bulkRefs, task) {
  const refs = bulkRefs.split(/[,\s]+/).map((x) => x.trim()).filter(Boolean);
  return {
    artifact: bulkArtifact.trim() || task.artifact || void 0,
    evaluation: bulkEval.trim() || task.evaluation || void 0,
...
function ContextGcChip({ compaction }) {
  const host = compaction?.host ?? "unknown";
  const hostLabel = host === "context-gc" ? "Context GC\xB7\u4E3B\u673A" : host === "default" ? "\u9ED8\u8BA4\u6458\u8981" : host === "unavailable" ? "GC \u4E0D\u53EF\u7528" : "GC \u72B6\u6001\u2026";
  const wired = (compaction?.web?.presets ?? []).filter((p) => p.action === "swapped" || p.action === "already").length;
  const webLabel = wired > 0 ? `\xB7${wired} \u9884\u8BBE` : "";
  const color = host === "context-gc" ? "var(--dsw-alias-success-strong, #059669)" : host === "default" || host === "unavailable" ? "var(--dsw-alias-label-secondary, var(--dsh-color-muted, #6b7280))" : "var(--dsw-alias-label-tertiary, #9ca3af)";
...
function EngramBoard({ api, onRequestClose }) {
  ...
  const [nodesByWs, setNodesByWs] = (0, import_react9.useState)({});
  const [linksByWs, setLinksByWs] = (0, import_react9.useState)({});
  const [viewMode, setViewMode] = (0, import_react9.useState)("board");
  ...
  const [bulkOpen, setBulkOpen] = (0, import_react9.useState)(false);
  const [bulkArtifact, setBulkArtifact] = (0, import_react9.useState)("");
  const [bulkEval, setBulkEval] = (0, import_react9.useState)("");
  const [bulkRefs, setBulkRefs] = (0, import_react9.useState)("");
  const [bulkBusy, setBulkBusy] = (0, import_react9.useState)(false);
  const [bulkMsg, setBulkMsg] = (0, import_react9.useState)(null);
  const [obsItems, setObsItems] = (0, import_react9.useState)(null);
  const [obsOpen, setObsOpen] = (0, import_react9.useState)(false);
  const [model, setModel] = (0, import_react9.useState)(null);
  const [modelOpen, setModelOpen] = (0, import_react9.useState)(false);
    ...
    try {
      ...
      const entries = await Promise.all(
        wsList.map(async (w) => {
          ...
          return [w, { tasks: res[0].items, nodes: res[1].items, links: res[2].items }];
        })
      );
      setTasksByWs((prev) => {
        const next = { ...prev };
  ...
  const wsNodesCount = overview === null ? 0 : ws === "" ? Object.values(overview.workspaces).reduce((acc, w) => acc + (w.nodes ?? 0), 0) : overview.workspaces[ws]?.nodes ?? 0;
  ...
  const allNodes = (0, import_react9.useMemo)(() => Object.values(nodesByWs).flat(), [nodesByWs]);
  const allLinks = (0, import_react9.useMemo)(() => Object.values(linksByWs).flat(), [linksByWs]);
  const nameOf = (0, import_react9.useMemo)(() => {
    const map = /* @__PURE__ */ new Map();
  ...
  const closeSelected = async () => {
    ...
    for (const t of closable) {
      try {
        ...
        if (out?.state === "stable") ok += 1;
        else fail += 1;
      } catch {
        fail += 1;
      }
    }
    setBulkMsg(ok > 0 ? `\u6279\u91CF\u5B8C\u6210\uFF1A${ok} \u4E2A\u4EFB\u52A1\u5DF2\u95ED\u73AF${fail > 0 ? ` \xB7 ${fail} \u4E2A\u672A\u8FBE\u8BC1\u636E\u95E8\uFF08\u89C1\u5355\u5361\u8868\u5355\u8865\uFF09` : ""}` : `\u672A\u95ED\u73AF\uFF1A${fail} \u4E2A\u672A\u8FBE\u8BC1\u636E\u95E8\uFF08\u89C1\u5355\u5361\u8868\u5355\u8865\uFF09`);
    setBulkBusy(false);
  ...
  const exportMd = () => {
    try {
      ...
      a.href = url;
      a.download = `esr-tasks-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.md`;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { "data-engram-board": "true", style: { ...vars, height: "100%", display: "flex", flexDirection: "column", overflow: "hidden", background: "var(--dsw-alias-bg-layer-1, var(--dsh-color-surface, #fff))" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: hb.header, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { style: hb.legendChip, children: "\u4EC5 ESR \xB7 \u4F1A\u8BDD\u5185 todo \u89C1\u8F93\u5165\u6846\u4E0A\u65B9\u4EFB\u52A1\u6761" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ContextGcChip, { compaction: overview?.compaction }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.seg, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", style: viewMode === "board" ? hb.segActive : hb.segBtn, onClick: () => setViewMode("board"), title: "\u56DB\u5217\u4EFB\u52A1\u770B\u677F", children: "\u770B\u677F" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", style: viewMode === "graph" ? hb.segActive : hb.segBtn, onClick: () => setViewMode("graph"), title: "\u5B9E\u4F53\u5173\u7CFB\u56FE\u8C31\uFF08esr_node / esr_link\uFF09", children: "\u56FE\u8C31" })
      ] }),
      ...
      viewMode === "board" && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
        selectedIds.size > 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("button", { type: "button", style: { ...hb.btn, background: "var(--dsw-alias-state-business-tertiary, rgba(99,102,241,.12))" }, onClick: () => {
          setBulkOpen(true);
          setCreating(false);
        }, children: [
          "\u6279\u91CF\u95ED\u73AF\uFF08",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", style: hb.btn, onClick: exportMd, title: "\u5BFC\u51FA\u5F53\u524D\u7B5B\u9009\u4E3A markdown", children: "\u5BFC\u51FA" }),
    ...
    viewMode === "board" ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.partition, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { style: hb.partitionTag, children: "\u539F\u751F todo \xB7 \u4F1A\u8BDD\u5185" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { children: [
          "\u7531 todo_write \u9A71\u52A8\uFF0C\u968F\u4F1A\u8BDD\u7ED3\u675F\uFF0C\u4E0D\u8DE8\u4F1A\u8BDD\u4FDD\u7559\uFF1B\u8981\u957F\u671F\u6C89\u6DC0\u7684\u591A\u6B65\u5DE5\u4F5C\uFF0C\u8BF7\u7528",
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("strong", { children: " esr_task / \u672C\u677F\u300C\u65B0\u5EFA\u300D" }),
          "\u5EFA\u4E3A ESR \u4EFB\u52A1\uFF08",
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { style: hb.partitionTagEsr, children: "ESR \xB7 \u8DE8\u4F1A\u8BDD\u95ED\u73AF" }),
          "\uFF09\uFF0C\u95ED\u73AF\uFF08artifact + evaluation + memory_refs \u8BC1\u636E\u95E8\uFF09\u540E\u8FDB [ENGRAM]\u3002"
        ] })
      ] }),
      showModelHint && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.modelHint, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { style: hb.partitionTagEsr, children: "\u5B9E\u4F53\u5EFA\u6A21" }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { children: [
          "\u8BE5\u8303\u56F4\u8FD8\u6CA1\u6709\u5B9E\u4F53\u56FE \u2014 \u7528 ",
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("strong", { children: "esr_node" }),
          " \u5EFA\u6A21\u53CD\u590D\u51FA\u73B0\u7684\u9886\u57DF\u5BF9\u8C61\uFF08\u5305/\u670D\u52A1/\u6587\u6863/\u6982\u5FF5\uFF09\uFF0C \u518D\u7528 ",
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("strong", { children: "esr_link" }),
          " \u5173\u8054\u5230\u4EFB\u52A1\u4E0E\u8282\u70B9\uFF0C\u4E0A\u65B9\u5207\u5230\u300C\u56FE\u8C31\u300D\u5373\u53EF\u67E5\u770B\u5B8C\u6574\u5B9E\u4F53\u5173\u7CFB\u56FE\u3002"
        ] })
      ] }),
      model && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.obsBar, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("button", { type: "button", style: hb.obsHead, onClick: () => setModelOpen((v) => !v), "aria-expanded": modelOpen, "aria-label": "\u5207\u6362\u5E38\u9A7B\u6458\u8981", children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.partitionTagEsr, children: [
            "\u5E38\u9A7B\u6458\u8981 \xB7 ",
            String(model.ws || "\u5168\u90E8\u5DE5\u4F5C\u533A").replace(/^.*[\\/]/, "") || "\u5168\u90E8"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.obsMeta, children: [
            "\u751F\u6210\u4E8E ",
            Math.max(0, Math.floor((Date.now() - model.generated_at) / 6e4)),
            " \u5206\u949F\u524D ",
            modelOpen ? "\u25BE" : "\u25B8"
          ] })
        ] }),
        modelOpen && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: { ...hb.obsBody, whiteSpace: "pre-wrap", fontFamily: "monospace", fontSize: 11, lineHeight: "16px" }, children: model.content })
      ] }),
      obsItems && obsItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.obsBar, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("button", { type: "button", style: hb.obsHead, onClick: () => setObsOpen((v) => !v), "aria-expanded": obsOpen, "aria-label": "\u5207\u6362\u89C2\u6D4B\u5217\u8868", children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.partitionTagEsr, children: [
            "\u89C2\u6D4B \xB7 \u4FE1\u5FF5 ",
            obsItems.length
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.obsMeta, children: [
            "\u7D2F\u8BA1 ",
            obsItems.reduce((sum, o) => sum + (o.proof?.count ?? 0), 0),
            " \u6761\u8BC1\u636E \xB7 ",
            TREND_LABEL[obsItems[0]?.trend ?? "new"],
            " ",
            obsOpen ? "\u25BE" : "\u25B8"
          ] })
        ] }),
        obsOpen && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: hb.obsBody, children: obsItems.slice(0, 20).map((o) => /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.obsRow, title: `\u8BC1\u636E ${o.proof.count} \u6761\uFF1A${(o.proof.sources ?? []).join(", ")}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { children: [
            (o.negations ?? 0) > 0 ? "\xAC " : "",
            o.text
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.obsMeta, children: [
            ...
            o.proof.count,
            " \xB7 ",
            TREND_LABEL[o.trend] ?? o.trend,
            (o.negations ?? 0) > 0 ? ` \xB7 \u53CD\u8BC1${o.negations}` : ""
          ] })
        ] }, o.id)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { padding: "0 14px" }, children: [
        ...
        bulkOpen && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.createForm, children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { fontSize: 11, color: "var(--dsw-alias-label-tertiary, var(--dsh-color-muted, #6b7280))" }, children: [
            "\u6279\u91CF\u95ED\u73AF ",
            selectedIds.size,
            " \u4E2A\u4EFB\u52A1 \u2014 \u4E09\u9879\u8BC1\u636E\u5E94\u7528\u5230\u6240\u6709\u9009\u4E2D\u9879\uFF08\u5355\u5361\u5DF2\u6709\u7684\u8BC1\u636E\u81EA\u52A8\u4FDD\u7559\uFF09"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("input", { style: hb.input, placeholder: "\u4EA7\u7269 artifact\uFF08\u6587\u4EF6/PR/\u8DEF\u5F84\uFF09", value: bulkArtifact, onChange: (e) => setBulkArtifact(e.target.value) }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("input", { style: hb.input, placeholder: "\u8BC4\u4F30 evaluation\uFF08\u6D4B\u8BD5/\u8BC4\u5BA1/\u5206\u6570\uFF09", value: bulkEval, onChange: (e) => setBulkEval(e.target.value) }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("input", { style: hb.input, placeholder: "\u8BB0\u5FC6\u5F15\u7528 memory_refs\uFF08#id, \u9017\u53F7\u5206\u9694\uFF09", value: bulkRefs, onChange: (e) => setBulkRefs(e.target.value) }),
          bulkMsg && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: { fontSize: 11, color: bulkMsg.startsWith("\u6279\u91CF\u5B8C\u6210") ? "#059669" : "#b45309" }, children: bulkMsg }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { display: "flex", gap: 6 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", style: hb.btnSolid, disabled: bulkBusy || selectedIds.size === 0, onClick: () => void closeSelected(), children: bulkBusy ? "\u2026" : "\u6309\u8BC1\u636E\u6279\u91CF\u95ED\u73AF" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", style: hb.btn, onClick: () => {
              setBulkOpen(false);
              setBulkMsg(null);
            }, children: "\u53D6\u6D88" })
          ...
          filtered.filter(col.match).slice(0, 20).map((t) => /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.card, children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { display: "flex", alignItems: "flex-start", gap: 6 }, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
                ...
                t.summary && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.compacted, title: "\u5DF2\u538B\u7F29 \xB7 \u539F\u6587\u4FDD\u7559\u5728\u5FEB\u7167\u4E2D\uFF08\u53EF\u56DE\u770B\uFF09", children: [
                  "\u{1F5DC} ",
                  t.summary
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { display: "flex", gap: 5, flexWrap: "wrap", marginTop: 3, alignItems: "center" }, children: [
                  ...
                  blockedBy(t, allTasks) > 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.lock, title: `\u88AB ${blockedBy(t, allTasks)} \u4E2A\u672A\u95ED\u73AF\u4EFB\u52A1\u963B\u585E\uFF0C\u5148\u5B8C\u6210\u5B83\u4EEC\u7684 deps`, children: [
                    "\u{1F512} ",
                    blockedBy(t, allTasks)
                  ] }),
                  t.assignee && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.meta, title: `claimed by ${t.assignee}`, children: [
                    "@",
                    shortAgent(t.assignee)
                  ] }),
                  (col.key === "gapped" || col.key === "ready") && taskGaps(t).map((g) => /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: hb.gap, children: [
                    g,
                    " \u2717"
                  ] }, g)),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { style: hb.meta, children: fmtDateShort(t.createdAt) })
                ] })
              ] })
            ] }),
    ...
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.graphWrap, children: [
      denied && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: hb.warn, children: "ESR \u770B\u677F\u6570\u636E\u4E0D\u53EF\u8FBE\uFF08loopback-only \u5B88\u536B\uFF09\u2014 \u4EFB\u52A1/\u5173\u7CFB/\u56FE\u8C31\u5C06\u65E0\u6CD5\u52A0\u8F7D\uFF1B\u8BF7\u901A\u8FC7\u672C\u673A\u8BBF\u95EE GUI\uFF0C\u6216\u653E\u5165\u53D7\u4FE1\u7F51\u7EDC\u8BBF\u95EE\u3002" }),
      error && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.error, children: [
        "\u26A0 ",
        error
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.graphPanel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: hb.graphHead, children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { style: { fontWeight: 700, fontSize: 13 }, children: "\u5173\u7CFB\u56FE\u8C31\uFF08esr_node / esr_link \u529B\u5BFC\u5411\u56FE\uFF09" }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: { fontSize: 11.5, fontWeight: 400, color: "var(--dsw-alias-label-tertiary, var(--dsh-color-muted, #6b7280))" }, children: [
            ws === "" ? "\u5168\u90E8\u5DE5\u4F5C\u533A" : ws.replace(/^.*[\\/]/, ""),
            " \xB7 \u5B9E\u4F53\u4E3A\u5706\u5F62\u8282\u70B9\uFF0C\u4EFB\u52A1\u4E3A\u52FE\u9009\u5FBD\u6807\uFF1B\u70B9\u9009\u8282\u70B9\u67E5\u770B\u5173\u7CFB\u660E\u7EC6"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(EngramGraph, { workspace: ws, entities: allNodes, tasks: allTasks, links: allLinks, nameOf })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: hb.footer, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { children: viewMode === "board" ? `${columnCounts.all} \u4E2A\u4EFB\u52A1\uFF08\u5F53\u524D\u7B5B\u9009\uFF09\xB7 \u6BCF 20s \u81EA\u52A8\u5237\u65B0 \xB7 \u6570\u636E\u6E90 ~/.dsh/storages/dsh_engram.json` : `${allNodes.length} \u4E2A\u5B9E\u4F53 \xB7 ${allLinks.length} \u6761\u5173\u7CFB \xB7 ${allTasks.length} \u4E2A\u4EFB\u52A1 \xB7 \u6BCF 20s \u81EA\u52A8\u5237\u65B0 \xB7 \u6570\u636E\u6E90 ~/.dsh/storages/dsh_engram.json` }) })
  ] });
}
var hb = {
  header: {
...
function apply(ctx) {
  ...
  const scope = new EngramScopeImpl(api, "dsh-engram");
