...
function LoomConfigCard({ scope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: vars, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.note, children: snap?.status === "unavailable" || snap?.status === "error" ? snap?.reason ?? "\u8BE5\u547D\u540D\u7A7A\u95F4\u5F53\u524D\u4E0D\u53EF\u7528\u3002" : snap?.writable ? "\u8BBE\u7F6E\u5BF9\u65B0\u5EFA\u4F1A\u8BDD\u5373\u65F6\u751F\u6548\uFF1B\u5DF2\u51BB\u7ED3\u7684 [LOOM] \u5757\u4FDD\u6301\u524D\u7F00\u7A33\u5B9A\u3002" : "\u8BE5\u547D\u540D\u7A7A\u95F4\u5F53\u524D\u4E3A\u53EA\u8BFB\uFF08\u5BBF\u4E3B\u672A\u6388\u6743\u5199\u5165\u6216\u9700\u91CD\u542F\u5E94\u7528\uFF09\u3002" }),
    error && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...s2.note, color: "#dc2626" }, children: error })
  ] });
}
