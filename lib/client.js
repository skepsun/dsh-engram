      ...
      children: [
        ...
        !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ed-anim", style: { padding: "2px 12px 12px 15px", display: "flex", flexDirection: "column", gap: 8 }, children: [
          ...
          !data.denied && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            ...
            data.tasks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: taskGrid, children: data.tasks.map((task) => {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "button",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: isStable ? "var(--dsw-alias-label-tertiary, var(--dsh-color-muted, #6b7280))" : "inherit" }, children: task.name })
                        ]
                      }
                    ),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { ...chip, ...statusColor, fontWeight: 700, flex: "none" }, title: gaps.length > 0 ? `\u8BC1\u636E\u7F3A\u53E3: ${gaps.join(", ")}` : label, children: isStable ? "STABLE" : gaps.length === 0 ? "READY" : `ACTIVE\xB7${gaps.length}` }),
