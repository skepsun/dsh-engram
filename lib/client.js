...
function LoomSection({ api, t }) {
  ...
  const [gcDryRun, setGcDryRun] = (0, import_react.useState)(true);
  const [gcReport, setGcReport] = (0, import_react.useState)(null);
  const [gcRunning, setGcRunning] = (0, import_react.useState)(false);
  ...
  ), gc && /* @__PURE__ */ React.createElement(
    StatCard,
    {
      num: String(gc.archivedMemories + gc.archivedTasks),
      label: `GC \u5DF2\u5F52\u6863 \xB7 \u94FE\u63A5-${gc.removedLinks}`
    }
  )), /* @__PURE__ */ React.createElement("div", { style: s.subPanel }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 700, fontSize: 13 } }, "\u8BB0\u5FC6 GC\uFF08pi-esr \u7EA6\u675F\uFF09"), /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12, display: "inline-flex", gap: 4, alignItems: "center" } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: gcDryRun, onChange: (e) => setGcDryRun(e.target.checked) }), "\u4EC5\u9884\u89C8\uFF08dry run\uFF09"), /* @__PURE__ */ React.createElement("button", { style: s.btnPrimary, onClick: () => void runGc(), disabled: gcRunning || !workspace }, gcRunning ? "\u2026" : "\u8FD0\u884C GC"), gc && gc.lastRun > 0 && /* @__PURE__ */ React.createElement("span", { style: s.mono }, "\u4E0A\u6B21 ", fmtDate(gc.lastRun))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11.5, color: "var(--dsh-color-muted, #6b7280)", marginTop: 4 } }, "\u5DE5\u4F5C\u96C6\uFF08active \u4EFB\u52A1\u5F15\u7528 / \u4EFB\u52A1\u8BB0\u5FC6 / \u5DF2\u5165\u7D22\u5F15\u547D\u4E2D\uFF09\u6C38\u4E0D\u9A71\u9010\uFF1BTTL \u8FC7\u671F\u5F52\u6863\u3001\u8D85\u5BB9\u91CF\u6DD8\u6C70\u3001stable \u4EFB\u52A1\u8D85\u7A97\u5F52\u6863\u3001\u60AC\u7A7A\u94FE\u63A5\u6E05\u7406\u3002\u53EA\u5F52\u6863\u4E0D\u786C\u5220\u2014\u2014\u6761\u76EE id \u4FDD\u6301\u53EF\u91CD\u53D6\u3002"), gcReport && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, fontSize: 12.5 } }, /* @__PURE__ */ React.createElement("div", null, gcReport.dryRun ? "dry-run \u9884\u89C8\uFF1A" : "\u5DF2\u6267\u884C\uFF1A", " ", "\u5F52\u6863\u8BB0\u5FC6 ", /* @__PURE__ */ React.createElement("b", null, gcReport.archivedMemories.length), " \xB7 \u5F52\u6863\u4EFB\u52A1 ", /* @__PURE__ */ React.createElement("b", null, gcReport.archivedTasks.length), " \xB7 \u6E05\u7406\u94FE\u63A5 ", /* @__PURE__ */ React.createElement("b", null, gcReport.removedLinks.length), " \xB7 \u4FDD\u62A4 ", /* @__PURE__ */ React.createElement("b", null, gcReport.protectedMemories)), gcReport.archivedMemories.slice(0, 5).map((e) => /* @__PURE__ */ React.createElement("div", { key: e.id, style: s.mono }, "- ", e.id.slice(0, 8), " ", e.reason, ": ", e.text)), gcReport.archivedTasks.slice(0, 3).map((t2) => /* @__PURE__ */ React.createElement("div", { key: t2.id, style: s.mono }, "- ", t2.id.slice(0, 6), " ", t2.reason, ": ", t2.name)), gcReport.removedLinks.slice(0, 3).map((l) => /* @__PURE__ */ React.createElement("div", { key: l.id, style: s.mono }, "- link ", l.source.slice(0, 8), " --", l.relation, "--> ", l.target.slice(0, 8))))), /* @__PURE__ */ React.createElement("div", { style: s.row }, /* @__PURE__ */ React.createElement("select", { style: s.input, value: workspace, onChange: (e) => setWorkspace(e.target.value) }, workspaces.length === 0 && /* @__PURE__ */ React.createElement("option", { value: "" }, "(no workspaces)"), workspaces.map((ws) => /* @__PURE__ */ React.createElement("option", { key: ws, value: ws }, ws))), /* @__PURE__ */ React.createElement("select", { style: s.input, value: kind, onChange: (e) => setKind(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "\u5168\u90E8\u7C7B\u578B"), kindsPresent.map((k) => /* @__PURE__ */ React.createElement("option", { key: k, value: k }, KIND_LABEL[k] ?? k))), /* @__PURE__ */ React.createElement(
    "input",
    {
