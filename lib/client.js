                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "button",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { ...chip, ...statusColor, fontWeight: 700, flex: "none", fontSize: 9.5, padding: "0 5px", lineHeight: "14px" }, title: gaps.length > 0 ? `\u8BC1\u636E\u7F3A\u53E3: ${gaps.join(", ")}` : label, children: isStable ? "STABLE" : gaps.length === 0 ? "READY" : `ACTIVE\xB7${gaps.length}` })
                        ]
                      }
                    ),
